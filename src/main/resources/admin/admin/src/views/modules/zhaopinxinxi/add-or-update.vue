<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="录用人数" prop="luyongrenshu">
          <el-input v-model="ruleForm.luyongrenshu" 
              placeholder="录用人数" clearable  :readonly="ro.luyongrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="录用人数" prop="luyongrenshu">
              <el-input v-model="ruleForm.luyongrenshu" 
                placeholder="录用人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopinrenshu = true;
          ...
          if(o=='luyongrenshu'){
            this.ruleForm.luyongrenshu = obj[o];
	    this.ro.luyongrenshu = true;
            continue;
          }
          if(o=='beizhu'){
