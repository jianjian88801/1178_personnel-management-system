    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="部门职责" prop="bumenzhize">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="部门职责"
                  v-model="ruleForm.bumenzhize" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bumenzhize" label="部门职责" prop="bumenzhize">
                    <span>{{ruleForm.bumenzhize}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
